...
import com.linecorp.armeria.kotlin.CoroutineContextUtil;
import com.linecorp.armeria.kotlin.CoroutineUtil;
...
public final class AnnotatedService implements HttpService {
    ...
    AnnotatedService(Object object, Method method,
        ...
        isKotlinSuspendingMethod = CoroutineUtil.isSuspendingFunction(method);
