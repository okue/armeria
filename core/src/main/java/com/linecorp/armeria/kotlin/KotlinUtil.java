...
public final class KotlinUtil {
    ...
    static {
        try {
            ...
            isKotlinReflectionPresent = false;
        }
    }

    public static boolean isKotlinReflectionPresent() {
        return isKotlinReflectionPresent;
    }

    public static boolean isKotlinMethod(Method method) {
        return method.getDeclaringClass().getAnnotation(Metadata.class) != null;
    }
